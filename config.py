...
config = Config(
    ...
    out_param_dir=os.path.join(DATASET_DIR, "estimated_param_logi"),
    est_label_folder_path=os.path.join(DATASET_DIR, "estimation_results_logi" + _PARAM_SUFFIX),
    ...
    oa_error_csv_path=os.path.join(DATASET_DIR, "estimation_results_logi" + _PARAM_SUFFIX, "oa_error_trend.csv"),
