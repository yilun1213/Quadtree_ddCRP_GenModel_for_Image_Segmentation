...
def estimate_segmentation(image_path, cfg: Config, oa_error_csv_path=None):
    ...
    est_label_folder_path = cfg.est_label_folder_path.replace("estimation_results", "estimation_results_icm")
    oa_log_filepath = cfg.oa_log_filepath.replace("estimation_results", "estimation_results_icm") if cfg.oa_log_filepath else None
    est_label_diff_dir = cfg.est_label_diff_dir.replace("estimation_results", "estimation_results_icm") if cfg.est_label_diff_dir else None
    
    region_output_dir = os.path.join(est_label_folder_path, cfg.est_region_dirname)
    quadtree_output_dir = os.path.join(est_label_folder_path, cfg.est_quadtree_dirname)
    label_output_dir = os.path.join(est_label_folder_path, cfg.est_label_dirname)
    label_vis_output_dir = os.path.join(label_output_dir, cfg.est_label_visualize_dirname)
    label_diff_output_dir = est_label_diff_dir
    ...
    return estimate_label_icm(
        ...
        label_diff_output_dir=label_diff_output_dir, oa_log_filepath=oa_log_filepath,
