...
# exp. 1.1.1 settings from experiments/exp_plan.md
MAX_DEPTH = 7
BRANCH_PROBS = [0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.0]
NUM_TREES = 50
SEED = 20260403
...
def save_depth_histogram(depth_counter: Counter[int], out_path: Path) -> None:
    ...
    draw.text((width // 2 - 170, 15), "Leaf Depth Distribution (exp. 1.1.1)", fill="black")
...
def main() -> None:
    ...
    print("exp. 1.1.1 quadtree generation completed")
